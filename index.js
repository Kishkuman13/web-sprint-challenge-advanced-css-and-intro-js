...
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 3: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀  
 ...
 function getArtistByIndex(array, numb) {
  return "the artist at index " + numb + " is " + array[numb].name;
}  
...
function get20s(array){
  ...
  for (let i=0; i<array.length; i++){
    var born = array[i].years.substring(0,4);
    var died = array[i].years.substring(7,11);
    if (born >= 1900 && died <= 2000) {
      century20.push(array[i].name);
    }
  }
  return century20;
}
...
function removeArtist(array, numb){
  array.splice(numb, 1);
  return array.length;
}
...
function addArtist(array){
    array.push({id: 20,
      name: 'Amos Martineau', 
      years: '1987 - 11/22/2020',
      genre: 'Web Design', 
      nationality: 'American',
      bio: "(Batman lorem ipsum is the best) I will be standing where l belong. Between you and the peopIe of Gotham. Bats frighten me. It is time my enemies shared my dread. I cannot do that as Bruce Wayne... as a man. I am flesh and blood. I can be ignored, destroyed. But as a symbol, I can be incorruptible, I can be everlasting."
    });
    console.log(array);
    return array;
  }
